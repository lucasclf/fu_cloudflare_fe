...
export function MonsterFormModal({ campaignId, onClose, onSuccess }: FormProps) {
  ...
  const { imgUrl, uploading: uploadingImage, imageFieldProps } = useFormImageUpload(campaignId, "monster");
