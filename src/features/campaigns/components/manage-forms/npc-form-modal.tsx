...
export function NpcFormModal({ campaignId, onClose, onSuccess }: FormProps) {
  ...
  const { imgUrl, uploading: uploadingImage, imageFieldProps } = useFormImageUpload(campaignId, "npc");
